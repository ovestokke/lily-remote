...
String g_activityMessage = "Activity actions are visual only; real writes disabled.";
String g_deviceControlMessage = "Device controls are visual only; real writes disabled.";
